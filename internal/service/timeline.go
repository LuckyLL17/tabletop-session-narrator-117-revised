...
func (
	...
	for turnIndex := range turns {
		...
		sequence := turn.Number - 1
		entry := domain.TimelineEntry{Sequence: sequence, Turn: turn, Events: []domain.ActionEvent{}, Highlights: []domain.Milestone{}, SeatName: names[turn.SeatID]}
